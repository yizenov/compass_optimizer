...
//          }
      ...
      std::cout << "time taken for gpu sketch reduction: " << elapsed << " ms" << std::endl;
...
//  int8_t* device_nbr = (int8_t*) device_id;
//  data_mgr->cudaMgr_->freeDeviceMem(device_nbr);
  return out_vec;
#else
  return {};
#endif
