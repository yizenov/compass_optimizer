...
class Executor {
 ...
 public:
  ...
  void setQueryStartTime(std::chrono::steady_clock::time_point query_start_time) { query_start_time_ = query_start_time; }
  std::chrono::steady_clock::time_point getQueryStartTime() { return query_start_time_; }
 ...
 private:
  ...
  std::vector<llvm::Value*> codegen(const std::vector<std::shared_ptr<Analyzer::Expr>> exprs,
